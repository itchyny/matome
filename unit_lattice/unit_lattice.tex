...
\[\xymatrix@=0.50in{
  ...
  \cell{\alpha}{s^{-2}}\dotted{d}\dotted{r} & \cell{f,\nu,\omega,\dd/\dd t}{Hz,s^{-1}} \dotted{r}\dotted{d} & *=0{} \arrmiddle{u}{m}{}\arrmiddle{r}{s}{}\dotted{d} & \cell{t,T}{s} \dotted{d} \\
  *=0{}\dotted{rr} & & \cell{k,\dd/\dd x,\nabla}{m^{-1}} \dotted{r} & *=0{}
}\]
...
\def\ItoE{\ar@/_2.5pc/[ll]_(.5){E=\frac12I\omega^2}}
\def\mtoI{\ar@/^2pc/[uu]^(.6){I=mr^2}}
\def\ktoE{\ar@/^3pc/[uu]^(.6){E=\frac12kx^2}}
\def\ktoF{\ar@{->}[u]_(.5){F=kx}}
\def\ptoF{\ar@{<->}[l]^(.5){\bm F=\dd \bm p/\dd t}_(.5){\bm I = \int \bm F \dd t}}
\def\ItoL{\ar@{->}[l]_(.5){\bm L=I\bm\omega}}
\def\ptoL{\ar@{->}[u]_(.5){\begin{smallmatrix}\bm L=\bm r \times \bm p(\text{angular\ momentum})\\\Delta x \Delta p \ge \hbar / 2\end{smallmatrix}}}
\def\WtoP{\ar@{->}[l]^(.6){P={\dd W}/{\dd t}}}
\def\LtoN{\ar@{->}[l]_(.45){\begin{smallmatrix}\bm N = \dd \bm L / \dd t{(\text{torque})}\\E=\hbar\omega\end{smallmatrix}}^(.4){S=\int L\dd t}}
\def\FtoN{\ar@{->}[u]_(.5){\begin{smallmatrix}\bm N = \bm r \times \bm F\\ W = F s\end{smallmatrix}}}
\def\rhotoP{\ar@{->}[uull]^(.5){P=\rho g h}}
\def\mtorho{\ar@{<->}[ddd]^(.5){\begin{smallmatrix}\rho=m/V\\m=\int_V \rho(\bm r)\dd V\end{smallmatrix}}}
\def\FtoP{\ar@/^3pc/[dd]^(.6){P=F/S}}
\def\NtoE{\ar@{->}@(ul,ur)^(.5){E=\abs{\bm N}\abs\theta}}
\def\mutotau{\ar@{->}[l]_(.5){\tau=\mu \partial u / \partial y}}
\[\xymatrix@=0.80in{
  \cell{P}{W,Jm^{-1}} \dotted{dd} & \cell{W,E,H,L,\bm N}{J,N m} \NtoE\WtoP & \cell{\hbar,S,\bm L,\bm S}{Js} \LtoN & \cell{I}{kgm^2}\ItoE\ItoL\dotted{r}\dotted{d} & *=0{}\dotted{dd} & \\
  ...
  *=0{} \dotted{r} & \cell{k}{Nm^{-1}} \ktoE\ktoF\dotted{rr} & & \cell{m}{kg}\mtop\mtoF\mtoE\mtorho\mtoI \arrmiddle{u}{m}{}\arrmiddle{r}{s}{} & *=0{} & \\
  & \cell{P,\tau}{Pa,Nm^{-2}} \dotted{u} & \cell{\mu(\mathrm{viscosity})}{Pa\cdot s}\dotted{u}\dotted{r}\dotted{dd}\mutotau & \\
  & \dotted{u}\dotted{rr} && \\
...
\[\xymatrix@=0.70in{
 ...
 \cell V V\arrupmiddle{ur}{s}{e=-\fracpd\varPhi t}\arrupbefore{rrru}{F}{Q=CV}      &          & \cell I A\arrupbeforebefore{ll}{O}{V=RI}\arrmiddle{ur}{s}{I=\diff Q t}\arrupbefore{lu}{H}{\varPhi=LI}|-(0.5)\hole        & \\
 & \cell{\A}{Wbm^{-1}} \arruubeforemiddlehole|!{[lu];[ruru]}\hole       & *=0{}       & \dottedholea{ll}\dotted{ld}\\
 \cell{\E}{Vm^{-1}}\arruumiddle{\E=\grad V}\dotted{rr} |!{+(20,-10);+(20,10)}\hole |!{+(32.5,-10);+(32.5,10)}\hole \dotted{ru}\arrowzz{rrrd}{Fm^{-1}}{\D=\varepsilon\E}\arrowyy{rrdd}{O^{-1}m^{-1}}{\J=\sigma\E}{Om}{\E=\rho\J } &          & \cell{\H,\M}{Am^{-1}}\arruubefore{\oint_C\H\cdot\dd s=I_f}\arrowz{dl}{Hm^{-1}}{\B=\mu\H}       & \\
 & \cell{\B}{T}\arruubeforemiddlehole \arrowyyy{uuuu}{m^2}{\varPhi=\int_S\B\cdot\dd\S} &        & \cell{\D,\P}{Cm^{-2}}\arruuuubefore{\oint_S\D\cdot\dd\bm{S}=Q}\dottedhole{ll}\dotted{ld}\\
